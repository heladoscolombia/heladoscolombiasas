...
class AccountMove(models.Model):
        ...
        try:
            if self.enable_support_document_related:
                ...
                if self.transmission_type == 'accumulated':
                    if (self.final_date_period-self.start_date_period).days>7:
                        _logger.info('El periodo a acumular no debe ser superior a 7 días')
                        raise ValidationError('El periodo a acumular no debe ser superior a 7 días')
    ...
    def _date_validation(self):
        for record in self:
            ...
            return True if dif.days >= 7 else False
